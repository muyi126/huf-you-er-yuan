 ...
 * 
 * @PullListViewHeader.java  2013-12-11 9:19:13 - Carson
 * @author YanXu
...
public class PullListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mHintTextView = (TextView) findViewById(R.id.listview_header_text);
	...
	public void setState(int state) {
		...
		case STATE_NORMAL:
			...
			mHintTextView.setText(R.string.pull_to_refresh_normal);
			break;
		case STATE_READY:
			if (mState != STATE_READY) {
				mArrowImageView.clearAnimation();
				mArrowImageView.startAnimation(mRotateUpAnim);
				mHintTextView.setText(R.string.pull_to_refresh_ready);
			}
			break;
		case STATE_REFRESHING:
			mHintTextView.setText(R.string.pull_to_refresh_loading);
			break;
		default:
		}
